...
-- VIEW ALL ROLES**************
    ...
    FROM department LEFT JOIN role 
...
-- ADD A ROLE**************
	...
	INSERT INTO role (title, salary, department_id)
		VALUE ('Head of Security', 55000, 7);
...
-- DELETE DEPARTMENT**************
	-- RENDERS role.department_id NULL FOR CORRESPONDING ROLES 
		-- PROMPT TO EITHER REASSIGN ROLES OR DELETE THEM, THEN GO THROUGH THE ROLE DELETE PROCESS
DELETE FROM department WHERE id = 7;


-- DELETE ROLES**************
	-- RENDERS employee.role_id NULL FOR CORRESPONDING ROLES - WILL NEED TO EITHER DELETE DEPENDENT TUPLES OR PROMPT FOR THEM TO BE RESET
		-- PERHAPS GO THROUGH EACH EMPLOYEE WITH A NULL VALUE AND PROMPT TO EITHER DELETE OR REASSIGN
	DELETE FROM role WHERE id = 17;
